...
const Delay = () => {
      ...
      >
        ...
        >
          ...
          <div className="d-flex gap-5 mt-4 mr-2">
            <Link to="/overview">
              <button type="button" className="overviewdelay mx-1">
                Overview
              </button>
            </Link>
            <Link to="/order">
            ...
            <Link to="/shipment">
              <button type="button" className="shipmentsdelay">
                Shipments
              </button>
            </Link>
            <Link to="/rto">
            ...
            <Link to="/courier">
              <button type="button" className="courierdelay">
                Courier
              </button>
            </Link>
            <Link to="/delay">
              <button type="button" className="delaydelay">
                Delay
              </button>
            </Link>
            <Link to="/tracking">
              <button type="button" className="trackingdelay">
                Tracking
              </button>
            </Link>
          </div>
  ...
  <div class="card mt-3">
    <div class="card-body">
     ...
     <div>
      <img  class="rounded mx-auto d-block mt-5" src={notfound} alt="" />
      <p style={{fontSize:"20px", fontWeight:"500", textAlign:"center"}}>Data not found for the selected filter</p>
     </div>
